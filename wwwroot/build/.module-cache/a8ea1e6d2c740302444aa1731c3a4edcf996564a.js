var InputText = React.createClass({displayName: "InputText",
    ...
    render: function () {
        return React.createElement("div", {className: "form-group"}, 
            ...
            React.createElement("input", {id: this.props.prop + 'Input', type: "text", className: "form-control", ref: "input", onChange: this.onChange})
        )
    }
});
...
var TextArea = React.createClass({displayName: "TextArea",
    ...
    render: function () {
        return React.createElement("div", {className: "form-group"}, 
            React.createElement("label", null, this.props.children), 
            React.createElement("textarea", {id: this.props.prop + 'Input', className: "form-control", ref: "input", onChange: this.onChange, rows: "5"})
        )
    }
});
