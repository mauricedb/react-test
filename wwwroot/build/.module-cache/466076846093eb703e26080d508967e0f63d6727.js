...
var TextArea = React.createClass({displayName: "TextArea",
    ...
    render: function () {
        return React.createElement("div", {class: "form-group"}, 
            React.createElement("label", null, this.props.children), 
            React.createElement("textarea", {className: "form-control", ref: "input", defaultValue: this.props.value})
        )
    }
});
...
var MovieEdit = React.createClass({displayName: "MovieEdit",
    ...
    render: function () {
        ...
        return React.createElement("form", null, 
            ...
            React.createElement(InputText, {value: this.state.movie.criticsConsensus}, "Critics Consensus"), 
